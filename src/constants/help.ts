...
export const LOGIN_PAGE_STEPS: Step[] = [
    {
        ...
        content: "Default admin account: visual-regression-tracker@example.com / 123456. Make sure to change default password."
    }, {
        target: `#${LOCATOR_LOGIN_FORM}`,
...
export const PROJECT_LIST_PAGE_STEPS: Step[] = [{
        ...
        content: "Default project is created after first start, feel free to edit/add/delete projects.",
        title: "Project List"
    },];
...
export const PROJECT_PAGE_STEPS: Step[] = [
    ...
    {
        target: "#" + LOCATOR_PROJECT_PAGE_BUILD_LIST,
        content: "If you see 'No Builds', please run your image comparison from any client."
    },
    {
...
export const TEST_VARIATION_LIST_PAGE = [
    {
        ...
        content: "Select the branch from/to which you want to merge the variations."
    }, {
