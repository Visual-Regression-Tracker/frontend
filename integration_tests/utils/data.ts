...
export const getProjectsDeleteUrl = (host: string, id: string) => `${host}/projects/${id}`;
export const getBuildsGetUrl = (projectId: string) => `${API_URL}/builds?projectId=${projectId}&take=10&skip=0`;
